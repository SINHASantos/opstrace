...
/// generated GetExporterResponse is wrong: missing underscores (capitalization meanwhile doesn't matter)
...
/// generated DeleteExporterResponse is wrong: missing underscores (capitalization meanwhile doesn't matter)
/// remove this if/when the generator is fixed
...
func (c *ExporterAccess) Insert(inserts []ExporterInsertInput) error {
	...
	var insertsWithTenant []ExporterInsertInput
