...
/// generated GetCredentialResponse is wrong: missing underscores (capitalization meanwhile doesn't matter)
...
/// generated DeleteCredentialResponse is wrong: missing underscores (capitalization meanwhile doesn't matter)
/// remove this if/when the generator is fixed
...
func (c *CredentialAccess) Insert(inserts []CredentialInsertInput) error {
	...
	var insertsWithTenant []CredentialInsertInput
